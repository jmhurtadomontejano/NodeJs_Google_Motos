...
class Server {
  ...
  rutas() {
    ...
    //delete PRODUCTOS
    this.app.delete("/webresources/generic/productos/:id", validarJWT, async function (req, res) {
        const id = req.params.id;
    ...
    /******* RUTAS DE LAS MOTOS *****/
    this.app.get("/webresources/generic/motos/:id", validarJWT, async function (req, res) {
        const id = req.params.id;
